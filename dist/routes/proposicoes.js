 ...
 *     tags:
 *       - Proposições
 *     summary: Simplify a proposição and return text + audio
 *     description: Generate a simplified summary for laypeople using Gemini 2.5 Flash, then generate audio with Gemini TTS and return both. Rate limited to 10 requests per minute.
 *     parameters:
 *       - name: id
 *         in: path
 *         required: true
 ...
 *     responses:
 *       200:
 *         description: Simplified summary and audio returned
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *         description: Internal server error
 */
router.get("/:id/simplify/audio/:taskId", proposicaoMiddleware_1.proposicaoRateLimiter, proposicaoController.getAudioTask);
/**
 * @openapi
 * /proposicoes:
 *   get:
